  ...
  return (
    <div style={containerStyle}>
      ...
      >
        ...
        <Link to="/admin/add-product" className="inline-block text-center text-white font-semibold text-sm rounded-2xl px-6 py-3 transition-transform duration-300 transform bg-gradient-to-br from-orange-500 to-orange-600 shadow-md hover:-translate-y-1">
          + Add Product
        </Link>
      </div>
