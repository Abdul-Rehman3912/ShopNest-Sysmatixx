    ...
    <div style={{ padding: "20px", maxWidth: "1000px", margin: "0 auto" }}>
      ...
      >
        ...
        <div style={{ display: "flex", gap: "15px", flexWrap: "wrap" }}>
          <button
            className="inline-block w-full text-center text-white font-semibold text-sm rounded-2xl px-6 py-3 transition-transform duration-300 transform bg-gradient-to-br from-orange-500 to-orange-600 shadow-md hover:-translate-y-1 sm:w-auto"
